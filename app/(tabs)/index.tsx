  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: palette.background }]}>
      <View style={styles.headerRow}>
        <View>
          <Text style={[styles.title, { color: palette.text }]}>Travel Diary</Text>
          <Text style={[styles.subtitle, { color: palette.mutedText }]}>Your saved memories</Text>
        </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TravelEntryItem
            ...
            theme={theme}
            onRemove={(id) => {
              Alert.alert('Remove Entry', 'Are you sure you want to delete this travel entry?', [
      ...
      <Pressable
        ...
        <Text style={[styles.floatingButtonText, { color: palette.background }]}>Add Entry</Text>
      </Pressable>
    </SafeAreaView>
  );
}
